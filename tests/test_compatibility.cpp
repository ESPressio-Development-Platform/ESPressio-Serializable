 ...
 * Inherited Memory Total: sizeof(Serializable::Serializable<VectorState>) [0 bytes dynamic allocation]
 * Members:
 ...
 * Total Memory: sizeof(Serializable::Serializable<VectorState>) + 25 bytes known members [_name: Capacity + 1 bytes when capacity exceeds 15-byte SSO]
