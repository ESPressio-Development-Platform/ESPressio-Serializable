 ...
 * Inherited Memory Total: sizeof(Serializable::Serializable<Current>) [0 bytes dynamic allocation]
 * Members:
 * - _port (int): 4 bytes [0 bytes dynamic allocation]
 * Total Memory: sizeof(Serializable::Serializable<Current>) + 4 bytes known members [0 bytes dynamic allocation]
