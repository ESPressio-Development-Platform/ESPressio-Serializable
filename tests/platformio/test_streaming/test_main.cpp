 ...
 * Members:
 * - _s (String): 12 bytes [Capacity + 1 bytes (Arduino String backing buffer when allocated)]
 * - _p (size_t): 4 bytes [0 bytes dynamic allocation]
 * Total Memory: sizeof(Stream) + 16 bytes known members [_s: Capacity + 1 bytes (Arduino String backing buffer when allocated)]
